...
run() ->
    ...
    FacilityProbeFilename =
        class_WebProbe:get_generated_html_filename( FacilityProbeName ),
    ...
    MyFacilityProbePid ! { setMainContent,
        [ "<p>This is example <b>HTML Content</b> of my test facility web "
          "probe.</p>" ],
        self() },
    ...
    FacSrvId = class_WebManager:start_facility_webserver( MyFacilityProbePid ),


    ?test_info( "Browsing the report results, if in batch mode." ),
    class_ResultManager:browse_reports(),

    class_WebManager:stop_facility_webserver( FacSrvId ),
