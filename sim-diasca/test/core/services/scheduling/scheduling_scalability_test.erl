...
% To avoid that Dialyzer resolves TestBatchOfCreations statically:
-export([ run/1 ]).
...
run( TestBatchOfCreations ) ->
	...
	PreCreation = time_utils:get_timestamp(),

	trace_utils:debug( "Starting batched creation." ),
