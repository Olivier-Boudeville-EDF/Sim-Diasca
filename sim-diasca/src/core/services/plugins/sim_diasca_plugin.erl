...
""".
-type plugin_data() :: option( term() ).


-doc """
Events the plugins will be notified of (corresponds to the functions that they
shall all implement):
...
may happen before 'on_simulation_stop': race conditions are tolerated here, for
plugins)
""".
...
-doc "Any data sent with events allowing it.".
...
Configuration changes will be propagated amongst plugins, which will be notified
in turn of these changes and will be given the opportunity to updated them.
...
-doc """
Callback triggered when the simulation case finished the creation of the initial
state of the simulation.
""".
...
-doc """
Callback triggered when a wallclock milestone is met (i.e. when a given duration
in real time elapsed).
""".
...
-doc """
Callback triggered when a tick milestone is met (i.e. when a given number of
...
met; only called on successful ending).
""".
