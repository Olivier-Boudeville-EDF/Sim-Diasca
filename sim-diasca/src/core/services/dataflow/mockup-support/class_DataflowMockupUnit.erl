...
apply_output_specs( [ _OutputMatchSpecs={ OutputPortNameSpec,
    ...
    OutputPortStatus =
        class_DataflowBlock:get_output_port_status( OutputPortNameSpec, State ),
...
-doc """
All-in-one function constructing a ad-hoc channel value from the user-defined
