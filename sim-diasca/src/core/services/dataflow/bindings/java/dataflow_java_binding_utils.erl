...
-moduledoc """
Module storing all the helper functions to facilitate the support of the binding
APIs for the Java language.
""".
...
-doc """
Returns the default Erlang-based unit type that is associated with any Java unit
type.
""".
