...
% Had to be commented for another strange compiler redefinition error:
...
-doc "A type designating the (non-const) returns of actor oneways.".
-type actor_oneway_return() :: class_Actor:actor_oneway_return().


-doc "A type designating the const returns of actor oneways.".
