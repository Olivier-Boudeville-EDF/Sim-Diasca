...
run( TestType ) ->
	...
	%TraceType = advanced_traces,
	%TraceType = { text_traces, text_only },
	%TraceType = { text_traces, pdf },

	%?case_start( TraceType ),

	% Any '--trace-type XXX' option specified on the command-line will be read:
	?case_start,
