...
-moduledoc "Class in charge of the **generation of adequate locations**.".
...
-export_type([ location_generator_pid/0 ]).
...
-doc """
Constructs a location generator, from following parameters:
...
-doc """
Generates randomly (with an uniform law) a new location within the world bounds.
...
-doc """
Generates randomly a new location within the world bounds, ensuring it is not in
the specified radius from any of the past generated locations.
""".
...
-doc """
Generates randomly a new location within the world bounds, ensuring it is not in
specified radius of any of the specified locations (regardless of the past
...
bounds, ensuring they are not in the specified radius GeneralRadius from any of
the already-generated locations nor in the specified radius PeerRadius from the
other locations generated by this call.
""".
...
-doc """
Returns a uniformly random location within the specified world bounds, each
...
-doc """
Generates at random a location that is not within Radius of specified locations.
""".
...
-doc """
Generates at random the specified number of locations, each further than
...
-doc """
Tells whether the specified location is close (based on the specified square
