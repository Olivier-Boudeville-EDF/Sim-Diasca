...
This means that it has a periodic schedule and that it can be also triggered by
messages.
...
-doc """
Constructs a female red squirrel actor:
...
Refer to `class_ForestDweller` for other attributes
""".
...
-doc """
Called by the forest for informing the winner of the competition; then the actor
sends a `youAreWinner` message to the winner.
""".
...
-doc """
Decides a gender for a newborn.

For reproductivity reasons, this function ensures that the first newborn is
...
-doc "Groups all spontaneous activities of this actor.".
trigger_spontaneous_activities( State ) ->
