...
% of processing units implemented natively and/or in Python and/or in Java
% and/or specified as a DUMF mockup.
%
...
%
-module(dataflow_urban_example_programmatic_with_all_vehicle_types_case).
...
run() ->
	...
	test_facilities:display( "Running a 'Dataflow Urban Example' simulation "
							 ...
							 "a processing units that are native, "
							 "Python-based, Java-based, and DUMF-based.",
	...
	SimulationSettings = #simulation_settings{
	  simulation_name="Urban Dataflow Programmatic Varied Example",
	...
	DeploymentSettings = #deployment_settings{
		...
		% A Python and a Java version of the VehicleTypeUnit class have been
		% designed and are tested here.
		%
		% Therefore the Python and Java bindings must be enabled:
		%
		enable_language_bindings = [ python, java ]
	...
	DataflowPid = class_Actor:create_initial_actor( class_Dataflow,
			[ "Urban Programmatic Overall Example Dataflow",
	...
	_UnitManagers = [ UrbanUnitManagerPid ] =
		class_DataflowUnitManager:create_managers( UnitManagerNames,
						ExperimentManagerPid, ActualBindingManagers,
						LoadBalancerPid ),
	...
	DistrictPid = class_DataflowObjectManager:create_initial_object(
					...
					[ "District-9",
					  [ "Columbia District", 1210.0, urban ] ] ),
	...
	_Buildings = [ FirstBuildingPid, _SecondBuildingPid ] =
		class_DataflowObjectManager:create_initial_objects(
		  ...
		  [
			  ...
			  %
			  [ "First Building", [ "4 Main Street, Forest Hills, NY",
									DistrictPid ] ],

			  [ "Second Building", [ "12 Walnut Avenue, Denver, Colorado",
									 DistrictPid ] ] ] ),
	...
	% Second, we consider the creation of various vehicle units of various
	% types:

	VehicleTypeSpec = class_DataflowMockupUnit:read_mockup_unit_spec(
						"VehicleTypeMockup.dumf" ),

	% A vehicle type unit takes here four specific construction parameters: its
	% name, its year of origin, its energy efficiency and its initial pollution
	% (in)efficiency.

	[ FirstNativeVehicleUnit, SecondNativeVehicleUnit ] =
		class_DataflowUnitManager:create_initial_units(
		  UrbanUnitManagerPid, class_VehicleTypeUnit,
		  DataflowPid,
		  [ [ "Native Zoe",  2020, 0.5, 1.0 ],
			[ "Native Yaris", 2010, 0.5, 1.0 ] ] ),

	[ FirstPythonVehicleUnit, SecondPythonVehicleUnit ] =
		class_DataflowUnitManager:create_initial_units(
		  UrbanUnitManagerPid, { class_VehicleTypeUnit, python },
		  DataflowPid,
		  [ [ "Python Zoe", 2021, 0.6, 2.0 ],
			[ "Python Yaris", 2011, 0.6, 2.0 ] ] ),

	[ FirstJavaVehicleUnit, SecondJavaVehicleUnit ] =
		class_DataflowUnitManager:create_initial_units(
		  UrbanUnitManagerPid, { class_VehicleTypeUnit, java },
		  DataflowPid,
		  [ [ "Java Zoe", 2022, 0.7, 3.0 ],
			[ "Java Yaris", 2012, 0.7, 3.0 ] ] ),

	[ FirstDUMFVehicleUnit, SecondDUMFVehicleUnit ] =
		class_DataflowUnitManager:create_initial_mockup_units(
		  UrbanUnitManagerPid, VehicleTypeSpec, DataflowPid,
		  [ "DUMF Zohe", "DUMF Yarix" ] ),
	...
	class_DataflowUnitManager:connect_to_iterated_initially(
	  ...
	  { [ FirstTransportUnit, SecondTransportUnit ],
		"energy_needed" },
	  { FirstNativeVehicleUnit, "energy_demand_estimates" } ),

	class_DataflowUnitManager:connect_to_iterated_initially(
	  UrbanUnitManagerPid,
	  { [ ThirdTransportUnit ], "energy_needed" },
	  { SecondNativeVehicleUnit, "energy_demand_estimates" } ),
	...
	class_DataflowUnitManager:connect_to_iterated_initially(
	  ...
	  { [ FirstTransportUnit, SecondTransportUnit ],
		"energy_needed" },
	  { FirstPythonVehicleUnit, "energy_demand_estimates" } ),

	class_DataflowUnitManager:connect_to_iterated_initially(
	  UrbanUnitManagerPid,
	  { [ ThirdTransportUnit ], "energy_needed" },
	  { SecondPythonVehicleUnit, "energy_demand_estimates" } ),
	...
	class_DataflowUnitManager:connect_to_iterated_initially(
	  ...
	  { [ FirstTransportUnit, SecondTransportUnit ],
		"energy_needed" },
	  { FirstJavaVehicleUnit, "energy_demand_estimates" } ),


	class_DataflowUnitManager:connect_to_iterated_initially(
	  UrbanUnitManagerPid,
	  { [ ThirdTransportUnit ], "energy_needed" },
	  { SecondJavaVehicleUnit, "energy_demand_estimates" } ),
	...
	class_DataflowUnitManager:connect_to_iterated_initially(
	  ...
	  { [ FirstTransportUnit, SecondTransportUnit ],
		"energy_needed" },
	  { FirstDUMFVehicleUnit, "energy_demand_estimates" } ),


	class_DataflowUnitManager:connect_to_iterated_initially(
	  UrbanUnitManagerPid,
	  { [ ThirdTransportUnit ], "energy_needed" },
	  { SecondDUMFVehicleUnit, "energy_demand_estimates" } ),
	...
	class_DataflowUnitManager:connect_to_iterated_initially(
	  ...
	  { [ FirstTransportUnit, SecondTransportUnit ],
		"pollution_exhausted" },
	  { FirstNativeVehicleUnit, "pollution_estimates" } ),

	class_DataflowUnitManager:connect_to_iterated_initially(
	  UrbanUnitManagerPid,
	  { [ ThirdTransportUnit ], "pollution_exhausted" },
	  { SecondNativeVehicleUnit, "pollution_estimates" } ),
	...
	class_DataflowUnitManager:connect_to_iterated_initially(
	  ...
	  { [ FirstTransportUnit, SecondTransportUnit ],
		"pollution_exhausted" },
	  { FirstPythonVehicleUnit, "pollution_estimates" } ),

	class_DataflowUnitManager:connect_to_iterated_initially(
	  UrbanUnitManagerPid,
	  { [ ThirdTransportUnit ], "pollution_exhausted" },
	  { SecondPythonVehicleUnit, "pollution_estimates" } ),
	...
	class_DataflowUnitManager:connect_to_iterated_initially(
	  ...
	  { [ FirstTransportUnit, SecondTransportUnit ],
		"pollution_exhausted" },
	  { FirstJavaVehicleUnit, "pollution_estimates" } ),

	class_DataflowUnitManager:connect_to_iterated_initially(
	  UrbanUnitManagerPid,
	  { [ ThirdTransportUnit ], "pollution_exhausted" },
	  { SecondJavaVehicleUnit, "pollution_estimates" } ),
	...
	class_DataflowUnitManager:connect_to_iterated_initially(
	  ...
	  { [ FirstTransportUnit, SecondTransportUnit ],
		"pollution_exhausted" },
	  { FirstDUMFVehicleUnit, "pollution_estimates" } ),

	class_DataflowUnitManager:connect_to_iterated_initially(
	  UrbanUnitManagerPid,
	  { [ ThirdTransportUnit ], "pollution_exhausted" },
	  { SecondDUMFVehicleUnit, "pollution_estimates" } ),
