...
-moduledoc "Experiment exit point, defined for testing.".
...
-doc """
The core of the behaviour of this base exit point, mostly adding to the default
exit point a fixed termination step.
""".
