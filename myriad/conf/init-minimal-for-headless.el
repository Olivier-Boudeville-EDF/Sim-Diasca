...
;; Derived on Tuesday, July 11, 2023 for our vanilla init.el.
...
;; To comment-out if not available/useful:
;;(require 'yaml-mode)
...
;; As the default prefix for smerge-mode, C-c^, is quite cumbersome:
...
;; Only for older Emacs apparently:
