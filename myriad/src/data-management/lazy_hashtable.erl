...
-doc """
Returns a lazy hashtable that started from LazyHashtableBase and was enriched
with the LazyHashtableAdd entries whose keys where not already in
