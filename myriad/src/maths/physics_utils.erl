...
-doc """
A ratio between the flow of the proper time of an observer and the overall time
coordinate.
...
-doc """
Electron charge (in absolute value), in kg^(1/2).m^(3/2)/s.
...
Mass of a stationary electron, also known as the invariant mass of the electron.
...
The proportionality factor that relates the average relative thermal energy of
particles in a gas with the thermodynamic temperature of the gas.
...
-doc """
Stefan-Boltzmann constant, in kg.s^-3.K^-4.

The factor of proportionality between the total energy radiated per unit surface
area per unit time (also known as the radiant exitance) and the fourth power of
the black body's temperature: M = Sigma.T^4.
...
-doc """
Returns the Lorentz factor ("gamma"), a quantity that expresses how much the
measurements of time, length, and other physical properties change for an object
while that object is moving.

S is the speed, i.e. the magnitude of the relative velocity between the inertial
reference frame of the object and the one of the observer.
...
-doc """
Returns the local gravitational acceleration at the specified distance from the
center of a spherically symmetric primary body (such as a star or a planet) of
the specified mass.
...
-doc """
Returns the escape velocity, that is the minimum speed needed for a free,
non-propelled object to escape at the specified distance from the gravitational
influence of a primary body of specified mass, thus reaching an infinite
distance from it.
...
-doc """
Returns the Schwarzschild radius, which corresponds to the radius defining the
event horizon of a Schwarzschild black hole of the specified mass.
...
-doc """
Returns the time factor that shall be applied to the proper time of an observer
located at the specified distance from a primary body of the specified mass,
...
-doc """
The mass, in kg, of our planet, the Earth.
...
-doc """
The mass, in kg, of our star, the Sun.
...
-doc """
The mass, in kg, of Sagittarius A*, the supermassive black hole at the Galactic
...
-doc """
The radius of our planet, the Earth.
...
-doc """
The radius of our star, the Sun.
