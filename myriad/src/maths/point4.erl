...
-doc "A point in a 4D space, with any numerical coordinates (4 of them).".
-type any_point4() :: point4() | integer_point4().



-doc "A 4D (floating-point) vertex of a mesh.".
-type vertex4() :: point4().



-doc "A 4D integer vertex of a mesh.".
...
-doc """
Returns a 4D point corresponding to the user-specified one (preferably a tuple
rather than a list).
...
-doc """
Returns a 4D point whose coordinates are all null, that is the origin of the
...
-doc """
Returns a 4D point corresponding to the specified vector (expected to be
type-homogeneous).
""".
...
-doc """
Returns a 4D vector (with floating-vector coordinates) corresponding to the
specified 4D point.
""".
...
-doc """
Returns a 4D vector (with coordinates of the same type) corresponding to the
specified 4D point.
""".
...
-doc """
Returns whether the two specified 4D points are close, that is if they could be
...
-doc """
Tells whether the specified 4D point P1 is within a distance D from 4D point P2,
...
-doc """
Tells whether the specified 4D point P1 is within a square distance SquareD from
4D point P2.
""".
...
-doc """
Returns the square of the distance between the two specified 4D points.
...
-doc """
Returns the distance between the two specified 4D points.
...
-doc """
Returns a textual representation of the specified 4D point; full float precision
is shown.
""".
...
-doc """
Returns a compact, textual, informal representation of the specified 4D point.
""".
...
-doc """
Returns a textual, more user-friendly representation of the specified 4D point;
