...
-moduledoc """
Module implementing the support for points in **arbitrary dimension**.
...
%
% We call here a container type-homogeneous if all the coordinates that it
% gathers are all either integer or floating-point ones.
...
""".
-type point() :: type_utils:tuploid( coordinate() ).
...
""".
-type integer_point() :: type_utils:tuploid( integer_coordinate() ).



-doc "A point of any dimension, with any numerical coordinates.".
...
-doc """
Returns an (arbitrary) point corresponding to the user-specified one (preferably
...
-doc """
Returns an (arbitrary) point of specified dimension whose coordinates are all
null.
""".
...
-doc """
Returns an (arbitrary) point corresponding to the specified vector (expected to
be type-homogeneous).
""".
...
-doc """
Returns an (arbitrary, and with floating-vector coordinates) vector
...
-doc """
Returns an (arbitrary, and with coordinates of the same type) vector
corresponding to the specified point.
""".
...
-doc """
Returns a point corresponding to the specified point translated by the specified
vector.
""".
...
-doc """
Returns whether the two specified points are close, that if they could be
...
-doc """
Returns whether the two specified points are equal, that if they could be
considered as representing the same point (equality operator on points).
""".
...
-doc """
Tells whether point P1 is within a distance D from point P2, using some margin
...
-doc """
Tells whether point P1 is within a square distance SquareD from point P2.
""".
...
-doc """
Returns a textual representation of the specified point; full float precision is
shown.
""".
...
-doc """
Returns a compact, textual, informal representation of the specified point.
""".
...
-doc """
Returns a textual, more user-friendly representation of the specified point;
