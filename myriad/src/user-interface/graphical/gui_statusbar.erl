...
-doc """
Creates and attaches a status bar at the bottom of the specified frame.
""".
...
-doc """
Creates and attaches a status bar of the specified style at the bottom of the
specified frame.
""".
...
-doc """
Sets the number of fields in which the specified status bar is to be (evenly)
split.
""".
...
-doc """
Sets the width of the fields of the specified status bar (and thus determines
...
-doc """
Pushes the specified text in the (first field of the) specified status bar.
""".
...
-doc """
Pushes the specified formatted text in the (first field of the) specified status
bar.
""".
...
-doc """
Pushes the specified text in the specified field of the specified status bar.
""".
...
-doc """
Converts the specified MyriadGUI status bar style elements into the appropriate
