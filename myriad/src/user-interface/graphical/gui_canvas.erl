...
% backbuffer may happen to be the final one of the former instance (i.e. showing
% the exact same content, although these OS processes should be totally
% unrelated). This can be detected with this test by clicking the 'Paste image'
% button on its first instance to make the previous buffer different from the
% next one. The second test instance will start with the same buffer content.
...
-doc "The actual canvas type we are to use.".
...
-doc """
Creates a (basic, plain) canvas, attached to the specified parent window.
...
-doc """
Sets the color to be used on the specified canvas for the drawing of the outline
of shapes.
""".
...
-doc """
Sets the color to be using on the specified canvas for filling surfaces.
...
-doc """
Sets the background color to be using on the specified canvas.
...
-doc """
Returns the RGBA value of the pixel at the specified position on the specified
canvas.
""".
...
-doc """
Sets the pixel at the specified position on the specified canvas to the current
RGBA point value.
""".
...
-doc """
Draws a line between the specified two points on the back-buffer of the
...
-doc """
Draws a line between the specified two points on the specified canvas, with the
specified color.
""".
...
-doc """
Draws lines between the pecified points, on the specified canvas, using the
current draw color.
""".
...
-doc """
Draws lines between the specified points, on the specified canvas, with the
specified color.
""".
...
-doc """
Draws a segment of the line L between the two specified ordinates on the
specified canvas.
...
-doc """
Draws the specified polygon on the specified canvas, closing the lines and
filling them.
""".
...
-doc """
Draws the specified label (a plain string) at the specified position, on the
specified canvas, using the current draw color.
""".
...
-doc """
Draws an upright cross at the specified location (2D point), with the specified
edge length.
""".
...
-doc """
Draws an upright cross at the specified location (2D point), with the specified
edge length and companion label, and with the specified color.
""".
...
-doc """
Renders the specified circle (actually, depending on the fill color, it may be a
 disc) on the specified canvas.
""".
...
-doc """
Draws the specified list of points, each point being identified in turn with one
cross and a label, corresponding to its rank order (P1 for the first point of
the list, P2 for the next, etc.).
""".
...
-doc """
Loads the image from the specified path into the specified canvas, pasting it at
...
-doc """
Loads the image from the specified path, pasting it on the specified canvas at
...
-doc "Resizes the specified canvas according to the specified size.".
...
-doc """
Returns the types of events regarding its panel that a canvas will register to
by default.
""".
...
-doc """
Creates a canvas, whose parent is the specified widget.
...
-doc """
Destructs the specified canvas.
...
-doc """
Updates the specified canvas state so that it matches any change in size of its
panel, and tells whether that canvas shall be repainted.

Typically used to be called initially (onShown); now called whenever the parent
...
-doc """
Resizes the specified canvas (which, in most cases, should be cleared and
repainted then).
""".
...
-doc """
Returns the client size of this canvas, as {IntegerWidth, IntegerHeight}.
""".
...
-doc """
Sets the pixel at the specified position to the current RGBA point value.
""".
...
-doc """
Draws lines between the specified list of points, on the specified canvas, using
...
-doc """
Draws lines between the specified list of points on the specified canvas, with
the specified color.
""".
...
-doc """
Renders the specified circle (actually, depending on the specified fill color,
it may be a disc) on the specified canvas.
""".
...
-doc """
Loads an image from the specified path into specified canvas, pasting it at its
upper left corner.
""".
...
-doc """
Loads an image from the specified path into the specified canvas, pasting it at
the specified location.
""".
