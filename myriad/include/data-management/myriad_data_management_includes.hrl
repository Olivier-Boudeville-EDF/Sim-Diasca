...
% Possibly useful:
-ifndef(myriad_data_management_includes_hrl_guard).
-define(myriad_data_management_includes_hrl_guard,).
...
-include("xml_utils.hrl").


-endif. % myriad_data_management_includes_hrl_guard
