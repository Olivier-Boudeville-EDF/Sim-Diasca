...
This repository, whose purpose is to complement the [main official page](https://www.edf.fr/en/the-edf-group/inventing-the-future-of-energy/r-d-global-expertise/our-offers/simulation-softwares/sim-diasca), is still work in progress.
...
<!--This main branch corresponds to the current stable version (2.4.1) of Sim-Diasca.-->

This main branch corresponds to the current in-development version (2.4.1) of Sim-Diasca.
